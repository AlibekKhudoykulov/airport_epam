...
public class AirportTest {
    ...
    public void testGetPassengerPlaneWithMaxCapacity() {
        ...
        Assert.assertTrue(expectedPlaneWithMaxPassengersCapacity.equals(airport.getPassengerPlaneWithMaxPassengersCapacity()));
    }
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        Assert.assertTrue(planesSortedByMaxLoadCapacity.equals(airport.sortByMaxLoadCapacity().getPlanes()));
    }

    @Test
    public void testGetInMilitaryPlanes() {
        Airport airport = new Airport(planes);
